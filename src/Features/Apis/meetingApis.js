...
export const meetingApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getMeetingById: builder.query({
            query: (id) => `Meetings/MeetingById/${id}`,
            providesTags: ['Meetings'],
        }),
        ...
        getAttendeesByMeetingId: builder.query({
            query: (meetingId) => `Attendees/AttendeesByMeetingId/${meetingId}`,
        ...
        getTopicsByMeetingId: builder.query({
            query: (meetingId) => `Topics/TopicsByMeetingId/${meetingId}`,
            providesTags: ['Topics'],
        }),
        ...
        getSignaturesByMeetingId: builder.query({
            query: (meetingId) => `Signatures/SignaturesByMeetingId/${meetingId}`,
...
// ✅ Export hooks
export const { useGetAllMeetingsQuery, useGetMeetingByIdQuery, useCreateMeetingMutation, useUpdateMeetingMutation, useDeleteMeetingMutation, useGetAttendeesByMeetingIdQuery, useAddAttendeeMutation, useUpdateAttendeeMutation, useUpdateAttendeeStatusMutation, useDeleteAttendeeMutation, useGetTopicsByMeetingIdQuery, useAddTopicMutation, useUpdateTopicMutation, useDeleteTopicMutation, useGetSignaturesByMeetingIdQuery, useAddSignatureMutation, useDeleteSignatureMutation, } = meetingApi;
