...
export default function AllSignatures() {
    ...
    return (_jsxs("div", { className: "p-6", style: { color: theme["base-content"] }, children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("h2", { className: "text-2xl font-bold", children: "All Signatures" }), _jsx("button", { className: "btn btn-primary", style: { backgroundColor: theme.primary, color: theme["base-100"] }, onClick: () => {
                            resetForm();
                            setOpenModal(true);
                                    ...
                                    return (_jsxs("tr", { style: {
                                            ...
                                            color: theme["base-content"],
                                                    ...
                                                    color: theme["base-content"],
                                                }, children: sig.role || "-" }), _jsx("td", { children: sig.signedAt ? new Date(sig.signedAt).toLocaleString() : "-" }), _jsxs("td", { className: "space-x-2", children: [_jsx("button", { className: "btn btn-sm btn-outline", style: { borderColor: theme.primary, color: theme.primary }, onClick: () => handleEdit(sig), children: "Edit" }), _jsx("button", { className: "btn btn-sm", style: { backgroundColor: theme.error, color: theme["base-100"] }, onClick: () => handleDelete(sig.id), children: "Delete" })] })] }, sig.id));
