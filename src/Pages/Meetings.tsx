...
const MeetingList: React.FC = () => {
  ...
  return (
    <>
      <Navbar />
      <div
        className="font-sans min-h-screen pt-[5rem] lg:pt-[6rem] pb-[4.5rem] lg:pb-0"
        style={{
      ...
      >
        ...
        >
          ...
          <p style={{ color: theme["base-content"] }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center px-4 sm:px-6 lg:px-20 mb-8">
          ...
          <input
            ...
            className="w-full sm:w-1/3 lg:w-1/4 px-4 py-2 border rounded-lg shadow-sm focus:outline-none"
            style={{
              backgroundColor: theme["base-200"],
              color: theme["base-content"],
              borderColor: theme.primary,
          ...
          {paginatedMeetings.length > 0 ? (
            paginatedMeetings.map((meeting: any, index: number) => (
              <motion.div
                ...
                className="p-6 rounded-xl shadow-md hover:shadow-lg flex flex-col justify-between border"
                style={{
                  backgroundColor: theme["base-100"],
                  color: theme["base-content"],
              ...
              >
                ...
                <motion.button
                  ...
                  className="mt-auto btn px-4 py-2 text-base sm:text-lg font-semibold w-full flex items-center justify-center gap-2"
                  style={{
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 px-6 lg:px-20 pb-12">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="border rounded-lg px-3 py-1 shadow-sm focus:outline-none"
                style={{
                  backgroundColor: theme["base-200"],
                  color: theme["base-content"],
                  borderColor: theme.primary,
              ...
              <span style={{ color: theme["base-content"] + "CC" }}>per page</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span style={{ color: theme["base-content"] + "CC" }}>
